...
// Get officer's sub division
$sql = "SELECT sub_division FROM FieldOfficer WHERE FOID = $foid";
$res = $con->query($sql);
$sub_division = "";
...
WHERE SD.paddy_status = 'Ongoing' 
  AND SD.verification_status IS NULL 
  AND L.agricultural_service_area = '$sub_division'";
...
<div class="container mt-4">
  <h3>🌾 Verify Completed Seasonal Details (Division: <?= htmlspecialchars($sub_division) ?>)</h3>
